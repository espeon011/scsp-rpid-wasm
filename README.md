...
[DIDP](https://github.com/domain-independent-dp/didp-rs) の Rust インターフェースである [RPID](https://github.com/domain-independent-dp/didp-rs) を用いて定義した最適化モデルを WASM ターゲットでコンパイルし, 
